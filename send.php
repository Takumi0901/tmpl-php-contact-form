<?php
  ...
  // 送信者の情報（メールヘッダー）
  $add_header = "From:muffin.kimura0901@gmail.com\n";

  // 送信者の情報（メールヘッダー）
  $add_header .= "Reply-to: muffin.kimura0901@gmail.com\n";
  $add_header .= "X-Mailer: PHP/". phpversion();

  // 送信エラーの時にエラーメールを返す先
  $opt = '-f'.'muffin.kimura0901@gmail.com';
...
HTML;
  ...
  mb_send_mail('muffin.kimura0901@gmail.com', "お問い合わせがありました", $message, $add_header, $opt);
